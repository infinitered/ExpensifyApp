...
class ShareViewController: UIViewController {
  ...
  func handlePost(_ items: [NSExtensionItem], extraData: [String:Any]? = nil) {
    DispatchQueue.global().async {
      ...
      guard let userDefaults = UserDefaults(suiteName: "group.com.expensify.chat.ir") else {
  ...
  func storeFile(withProvider provider: NSItemProvider, _ semaphore: DispatchSemaphore) {
    provider.loadItem(forTypeIdentifier: kUTTypeData as String, options: nil) { (data, error) in
      ...
      guard let groupFileManagerContainer = FileManager.default
              .containerURL(forSecurityApplicationGroupIdentifier: "group.com.expensify.chat.ir")
      else {
        self.exit(withError: NO_APP_GROUP_ERROR)
        return
      }
